    ...
    <section className="section-full relative flex items-center overflow-hidden">
      ...
      >
        <div className="max-w-5xl">
          ...
          <h2 className="animate-item font-display text-5xl md:text-6xl lg:text-7xl text-white mb-4 text-shadow">
            {section.title}
          </h2>
          <p className="animate-item text-lg text-white/70 mb-12">
            {section.subtitle}
          </p>
